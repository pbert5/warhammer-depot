...
# Depot tests and deterministic checks
...
# Munda Manager standalone (the independently maintained submodule topology)
docker compose -f vendor/mundamanager/compose.standalone.yaml up -d --build
